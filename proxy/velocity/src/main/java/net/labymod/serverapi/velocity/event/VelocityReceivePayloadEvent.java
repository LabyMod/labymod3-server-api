...
public class VelocityReceivePayloadEvent {
  ...
  /**
   * Initializes a new {@link VelocityReceivePayloadEvent} with the given {@code uniqueId},
   ...
   */
  public VelocityReceivePayloadEvent(UUID uniqueId, String identifier, byte[] payload) {
