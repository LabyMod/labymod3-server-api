...
public class ReceivePlayerPayloadEvent {
  ...
  /**
   * Initializes a new {@link ReceivePlayerPayloadEvent} with the given {@code uniqueId}, {@code
   * identifier} and {@code payload}.
   *
   ...
   */
  public ReceivePlayerPayloadEvent(UUID uniqueId, String identifier, byte[] payload) {
