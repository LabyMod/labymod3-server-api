 ...
 */
public interface CineScopesTransmitter {

  /**
   * Transmits the cine scope packet to the client.
   *
  ...
  /**
   * Transmits the cine scope packet to all online laby users.
   *
   * @param showCineScopes {@code true} if the black bar should be fade in, for fade out {@code
   *     false}.
   * @param coveragePercent The height of the black bars in percent. The minimum of the black bars
   ...
   * @param duration The duration.
   */
  void broadcastTransmit(boolean showCineScopes, int coveragePercent, long duration);
}
