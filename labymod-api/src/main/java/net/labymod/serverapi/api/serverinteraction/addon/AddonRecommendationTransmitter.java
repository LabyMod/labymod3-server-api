 ...
 * required.
 */
public interface AddonRecommendationTransmitter {
   ...
   */
  AddonRecommendationTransmitter addRecommendAddon(RecommendedAddon recommendedAddon);
   ...
   * @return This object for a fluent chaining.
   */
  AddonRecommendationTransmitter addRecommendAddons(RecommendedAddon... recommendedAddons);

  /**
   * Transmits the addon recommendation packet to the client.
   *
