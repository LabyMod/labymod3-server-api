...
public interface PayloadCommunicator {
   ...
   *
   * @param uniqueId The unique identifier of a player that is to receive the payload.
   ...
   *
   * @param uniqueId TThe unique identifier of a player that is to receive the payload.
   * @param payload The payload as a byte array.
   */
  ...
  /**
   * Sends a custom payload message to the `labymod3:main` channel with the `server_api` key.
   *
   * @param uniqueId The unique identifier of a player that is to receive the payload.
   */
  void sendServerApiMessage(UUID uniqueId);

  /**
   * Receives a custom payload from the given channel {@code identifier}.
   *
   * @param uniqueId The unique identifier of a player that sent the payload.
